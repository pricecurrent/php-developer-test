...
var _People = require('./components/views/People');

var _People2 = _interopRequireDefault(_People);

var _Person = require('./components/views/Person');
...
var vue = new _vue2.default({
    ...
    components: {
        PeopleView: _People2.default, PersonView: _Person2.default
    }
});

exports.default = vue;

},{"./components/views/People":49,"./components/views/Person":50,"vue":41,"vue-resource":30}],44:[function(require,module,exports){
'use strict';
...
},{"./VM":43,"bootstrap":1,"jquery":14}],45:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    methods: {
        save: function save() {
            ...
            this.$http.post('/families', this.newFamily).then(function (response) {
                _this.$dispatch('notify-new-family');
                _this.hide();
            });
        },
        hide: function hide() {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/andrew/Code/CodeMyView/php-developer-test/resources/assets/js/components/Family/Add.vue"
  if (!module.hot.data) {
...
},{"../global/Modal.vue":48,"vue":41,"vue-hot-reload-api":16}],46:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    methods: {
        save: function save() {
            ...
            this.$http.post('/people', this.newPerson).then(function (response) {
                _this.$dispatch('notify-new-person');
                _this.hide();
            });
        },
        hide: function hide() {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/andrew/Code/CodeMyView/php-developer-test/resources/assets/js/components/People/Add.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"../global/Modal.vue":48,"vue":41,"vue-hot-reload-api":16}],47:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    methods: {
        potentialFamily: function potentialFamily(family_id) {
            var _this = this;

            this.$http.get('/families/available-positions', { family_id: family_id, personId: this.personId }).then(function (response) {
                _this.potentialFathers = response.data.fathers;
                _this.potentialMothers = response.data.mothers;
                _this.potentialSpouses = response.data.spouses;
            });
        },
        save: function save() {
            var _this2 = this;

            var data = this.newFamily;
            data.family_id = this.family_id;

            this.$http.post('/people/' + this.personId + '/attach-to-family', data).then(function (response) {
                _this2.$dispatch('person-got-a-family');
                _this2.hide();
            });
        },
        fetchFamilies: function fetchFamilies() {
            ...
            this.$http.get('/families').then(function (response) {
                _this3.families = response.data;
            });
        },
        potentialMothers: function potentialMothers(params) {
            this.$http.post('families/potential-mothers', params).then(function (response) {});
        },
        hide: function hide() {
            this.newFamily = {
    ...
    watch: {
        family_id: function family_id(_family_id) {
            this.potentialFamily(_family_id);
        }
    },
...
},{"../global/Modal.vue":48,"vue":41,"vue-hot-reload-api":16}],48:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/andrew/Code/CodeMyView/php-developer-test/resources/assets/js/components/global/Modal.vue"
...
},{"vue":41,"vue-hot-reload-api":16,"vueify-insert-css":42}],49:[function(require,module,exports){
'use strict';

var _Add = require('../People/Add.vue');

var _Add2 = _interopRequireDefault(_Add);

var _Add3 = require('../Family/Add.vue');
...
module.exports = {
    ...
    components: {
        addPerson: _Add2.default, addFamily: _Add4.default
    },
    ...
    methods: {
        fetchPeople: function fetchPeople() {
            ...
            this.$http.get('/people/orphans').then(function (response) {
                _this.orphans = response.data;
            });
        },
        fetchFamilies: function fetchFamilies() {
            var _this2 = this;
    ...
    events: {
        'notify-new-person': function notifyNewPerson() {
            this.fetchPeople();
        },

        'notify-new-family': function notifyNewFamily() {
            this.fetchFamilies();
        }
    },
...
},{"../Family/Add.vue":45,"../People/Add.vue":46}],50:[function(require,module,exports){
'use strict';

var _GiveFamily = require('../People/GiveFamily.vue');

var _GiveFamily2 = _interopRequireDefault(_GiveFamily);
...
module.exports = {
    ...
    components: {
        'give-family': _GiveFamily2.default
    },

    data: function data() {
        return {
            giveFamilyModal: false
        };
    }
};

},{"../People/GiveFamily.vue":47}]},{},[44]);
